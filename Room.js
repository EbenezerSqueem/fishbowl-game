class Room {
  ...
  constructor(roomOwnerSocket, roomCode, gameDetails, jitsiRoom) {
    ...
    // set game settings
    this.roomDetails.gameSettings.numberOfPlayers = Number.parseInt(
      gameDetails.numberOfPlayers
    );
    this.roomDetails.gameSettings.timePerTurn = Number.parseInt(
      gameDetails.timePerTurn
    );
    this.roomDetails.gameSettings.wordsPerPlayer = Number.parseInt(
      gameDetails.wordsPerPlayer
    );
    this.roomDetails.gameSettings.numberOfRounds = Number.parseInt(
      gameDetails.numberOfRounds
    );
    this.roomDetails.jitsiRoom = jitsiRoom;
  }
