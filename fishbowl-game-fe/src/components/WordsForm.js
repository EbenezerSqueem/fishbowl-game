...
export default class WordForm extends Component {
    ...
    submitWords = (e) => {
        ...
        if(this.props.numberOfWords !== Object.keys(this.state.words).length) {
            ...
            socket.emit("submit-words", this.state.username, this.props.roomCode, this.state.words);
    ...
    render() {
        ...
        let username = [];
        // if this.props.numberOfLocalPlayers 
        return (
            <div className="word-form-container">
                <div className="word-form-label">Enter your game words</div>
                {this.props.numberOfLocalPlayers > 1 &&<div className="word-form-details">Player {this.props.numberOfUsersSubmitted + 1} of {this.props.numberOfLocalPlayers}</div>}
                <div className="form-inputs">
                    ...
                    {this.state.invalidUsernameError && <div className='input-error'>this username already exists, please select another</div>}
                    {wordInputs}
                </div>
