    ...
    return(
        <div className='title-screen-container'>
            <div className="title-logo-container">
                <img src="../FishbowlLogo.png" alt="Fishbowl-Icon" />
                <div className="game-title">
                    <p className="game-title-fish">FISH</p>
                    <p className="game-title-bowl">BOWL</p>
                </div>
            </div>
            <button className="fb-game-btn" onClick={toggle_createModal}>Create Game</button>

            <button className="fb-game-btn" onClick={toggle_joinModal}>Join Game</button>

            <Modal className="modal-container" isOpen={createRoom_modal} toggle={toggle_createModal}>
                <ModalHeader toggle={toggle_createModal}></ModalHeader>
                <ModalBody>
                    <CreateRoom />
                </ModalBody>
            </Modal>
            <Modal className="modal-container" isOpen={joinRoom_modal} toggle={toggle_joinModal}>
